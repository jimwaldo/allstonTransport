...
1. Run `build_transition_d.py`, which implicitly takes as input `student_schedule_d.pkl` (generated by `student_schedule.py`). This produces a dictionary keyed by student id that shows the transitions across the river for each time and day
...
**build_conflicts_d.py**: TODO

**make_csv_conflicts.py**: TODO